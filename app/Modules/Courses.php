...
class Courses extends Model
{
    ...
    protected $fillable = ['course_id', 'title', 'description', 'lecturer_id','lecturer_name','cover','coin_price','now_price','is_live','audio_url','opened_at','created_at',
        'create_user','updated_at','update_user','status','closed_at','is_home','is_good','is_oa','praise_count','c_id','is_publish','is_try','im_group_id','view_level','is_del','img_list','can_talk','is_zip'];
